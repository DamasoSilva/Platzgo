  ...
  return (
    <>
      ...
      <div className="pb-10 space-y-5">
        {/* Back button */}
        <Link href="/meus-agendamentos" className="inline-flex items-center gap-1.5 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
